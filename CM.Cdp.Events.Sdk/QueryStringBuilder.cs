...
namespace CM.Cdp.Events.Sdk
{
    ...
    public sealed class QueryStringBuilder
    {
        ...
        public QueryStringBuilder Add([NotNull] string key, [CanBeNull] object value)
        {
            ...
            _result += _result.Contains("?") ? "&" : "?";
            _result += $"{key}={HttpUtility.UrlEncode(Convert.ToString(value, CultureInfo.InvariantCulture))}";
            ...
            [NotNull] Func<T, object> transform)
        {
            ...
            Add(key, source.Select(transform).Where(value => value != null));
